...
def parse_args():
    ...
    parser.add_argument('--gpu', type=str, dest='gpu_ids', default='6')
    parser.add_argument('--img_path0', type=str, default='demoinput/oy_080.png')
    parser.add_argument('--img_path1', type=str, default='demoinput/rxy_41100.png')
    parser.add_argument('--output_folder', type=str, default='demooutput')
